...
The [&lt;region&gt;](../region/) element defines the initial values for the left, right,
top, bottom, height, width, and zIndex properties of a [&lt;media&gt;](../media/) element
that indirectly refers to it by using a [&lt;descriptor&gt;](../descriptor/) element.

The position of a region, as specified by its *top*, *bottom*,
*left*, and *right* attributes, is always relative to the parent
geometry, which is defined by the parent [&lt;region&gt;](../region/) element, or the total
...
| --- | --- | --- | --- |
| [&lt;region&gt;](../region/) | <u>*id*</u>, *title*, *left*, *right*, *top*, *bottom*, *height*, *width*, *zIndex* | ([&lt;region&gt;](../region/))* | [&lt;regionBase&gt;](../regionbase/) or [&lt;region&gt;](../region/) |
