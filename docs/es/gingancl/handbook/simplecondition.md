...
El elemento [&lt;simpleCondition&gt;](../simplecondition/) define una condición simple para activar
acciones en una relación causal.

El elemento [&lt;simpleCondition&gt;](../simplecondition/) tiene un rol *atributo*, cuyo valor
...
Un [&lt;simpleCondition&gt;](../simplecondition/) también define un tipo de evento (*eventType*
...
número de enlaces) cuando el [&lt;causalConnector&gt;](../causalconnector/) se utiliza para crear un
[&lt;link&gt;](../link/).  Si el valor máximo es mayor que uno, un calificador
...
También se puede definir un atributo de retraso para [&lt;simpleCondition&gt;](../simplecondition/),
...
| --- | --- | --- | --- |
| [&lt;simpleCondition&gt;](../simplecondition/) | <u>*rol*</u>, *retraso*, *eventType*, *key*, *transition*, *min*, *max*, *calificador* | -- | [&lt;causalConnector&gt;](../causalconnector/) o [&lt;compoundCondition&gt;](../compoundcondition/) |
