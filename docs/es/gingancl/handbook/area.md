...
El elemento [&lt;area&gt;](../area/) permite definir un ancla de contenido (un subconjunto de
unidades de información del contenido de un [&lt;media&gt;](../media/) elemento) que pueden usarse en
...
Cada elemento [&lt;media&gt;](../media/), [&lt;context&gt;](../context/), [&lt;body&gt;](../body/) y [&lt;switch&gt;](../switch/)
...
| --- | --- | --- | --- |
| [&lt;area&gt;](../area/) | <u>*id*</u>, *coords*, *begin*, *end*, *beginText*, *endText*, *beginPosition*, *endPosition*, *primero*, *último*, *etiqueta*, *clip* | -- | [&lt;media&gt;](../media/) |
...
| *clip* | <p>String.</p><p>The value depends on the declarative hypermedia object type. For NCL media objects, the clip value is a triple <"(chainId,beginOffset,endOffset)"> that is used by the NCL media player to identify an NCL application [&lt;port&gt;](../port/) through which a temporal chain begins, and the beginning and the end time in this temporal chain.</p><p>For [&lt;media&gt;](../media/) elements with NCL code content the following defaults are defined:</p><ol><li class="level1"><div class="li">"chainId" is the whole content anchor of the [&lt;body&gt;](../body/) element,</div></li><li class="level1"><div class="li">"beginOffset" is "0s", and</div></li><li class="level1"><div class="li">"endOffset" is the end time of the temporal chain.</div></li></ol> | The *clip* identifies a stream clip in the content of a declarative hypermedia object |
