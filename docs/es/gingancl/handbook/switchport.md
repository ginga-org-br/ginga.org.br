...
El elemento [&lt;switchPort&gt;](../switchport/) define una asignación a un subconjunto del
[&lt;switch&gt;](../switch/) componentes del elemento.  Todas las referencias a un interruptor interno.
El componente debe realizarse a través de un elemento [&lt;switchPort&gt;](../switchport/) o, por defecto,
al elemento [&lt;switch&gt;](../switch/) sin especificar ningún [&lt;switchPort&gt;](../switchport/). en
En este último caso, se considera como si se hiciera referencia a un incumplimiento.
[&lt;switchPort&gt;](../switchport/) que contiene elementos de mapeo para cada objeto secundario del
