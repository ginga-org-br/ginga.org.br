...
El elemento [&lt;media&gt;](../media/) define un objeto multimedia que contiene: medios perceptivos
...
- El tipo "application/x-ncl-NCL" (o "application/x-ginga-NCL") es
    aplicado a [&lt;media&gt;](../media/) elementos con contenido de código NCL (tenga en cuenta que
    una aplicación NCL puede incorporar otra aplicación NCL).

- El tipo "application/x-ncl-NCLua" (o "application/x-ginga-NCLua") es
    aplicado a [&lt;media&gt;](../media/) elementos con contenido de código imperativo Lua.

- La "aplicación/x-ncl-settings" (o "aplicación/x-ginga-settings") es
    aplicado a un elemento [&lt;media&gt;](../media/) especial (puede haber solo uno en un
    documento NCL, pero puede reutilizarse como elemento secundario de otros
    [&lt;context&gt;](../context/) elementos) cuyas propiedades son variables globales
    ...
    evaluaciones definidas por [&lt;rule&gt;](../rule/) elementos. Para poder utilizar estos
    propiedades en [&lt;link&gt;](../link/) definiciones de elementos, deben ser explícitamente
    declarado.

- El tipo application/x-ncl-time (o application/x-ginga-time) será
    aplicado a un elemento [&lt;media&gt;](../media/) especial (puede haber solo uno en un
    documento NCL, pero puede reutilizarse como elemento secundario de otros
    [&lt;context&gt;](../context/) elementos), cuyo contenido es el UTC. Cuando se inicia,
    el contenido UTC no se exhibe; sin embargo, se puede utilizar para definir
    anclajes de contenido mediante el uso de elementos [&lt;area&gt;](../area/). Tenga en cuenta que cualquier continuo
    El elemento [&lt;media&gt;](../media/) sin fuente especificada se puede utilizar para definir un
    reloj relativo a la hora de inicio del elemento [&lt;media&gt;](../media/).

#### Reutilización de objetos multimedia { data-search-exclude }

Excepto [&lt;media&gt;](../media/) elementos de "application/x-ncl-NCL" y
Tipos "application/x-ncl-NCLua", un elemento [&lt;media&gt;](../media/) puede hacer referencia a otro
[&lt;media&gt;](../media/) elemento del mismo documento o a un [&lt;media&gt;](../media/) importado
...
- Atributo *instancia*, que puede definirse; de lo contrario, tiene "nuevo" como
  ...
  - Se pueden agregar elementos secundarios [&lt;area&gt;](../area/). Si el nuevo agregado [&lt;area&gt;](../area/)
    El elemento tiene el mismo atributo *id* de un elemento ya existente.
    elemento [&lt;area&gt;](../area/) (definido en el elemento [&lt;media&gt;](../media/) reutilizado), el
    El reproductor NCL ignora el nuevo [&lt;area&gt;](../area/) agregado.

  - Se pueden agregar elementos secundarios [&lt;property&gt;](../property/). Si el nuevo agregado
    El elemento [&lt;property&gt;](../property/) tiene el mismo atributo de nombre que un elemento ya
    elemento [&lt;property&gt;](../property/) existente (definido en el [&lt;media&gt;](../media/) reutilizado
    elemento), el reproductor NCL ignora el nuevo [&lt;property&gt;](../property/) agregado.
...
Se debe respetar la siguiente semántica al reutilizar un [&lt;media&gt;](../media/)
elemento. Supongamos el conjunto de [&lt;media&gt;](../media/) elementos compuestos por el referido
[&lt;media&gt;](../media/) elemento y todos los elementos [&lt;media&gt;](../media/) de referencia.

- Si algún elemento del subconjunto formado por el referido elemento [&lt;media&gt;](../media/)
    y todos los demás elementos [&lt;media&gt;](../media/) que tengan el atributo de instancia igual
    a "instSame" o "gradSame" está programado para ser presentado, todos los demás
    elementos de este subconjunto, que no son descendientes de un [&lt;switch&gt;](../switch/)
    ...
    instancia de presentación. Elementos descendientes de un elemento [&lt;switch&gt;](../switch/)
  ...
  - Si el atributo de instancia es igual a "gradSame", todos los nodos programados
      ...
      desde un enlace, etc.
  - A medida que cada elemento [&lt;media&gt;](../media/) comienza su presentación, el común
      instancia en la presentación debe notificar los eventos asociados con
      sus elementos [&lt;area&gt;](../area/) y [&lt;property&gt;](../property/).

- Los [&lt;media&gt;](../media/) elementos del conjunto que tienen valores de atributos de instancia
...
| --- | --- | --- | --- |
| [&lt;media&gt;](../media/) | <u>*id*</u>, *src*, *tipo*, *referencia*, *instancia*, *descriptor* | ([&lt;area&gt;](../area/) &#124; [&lt;property&gt;](../property/))* | [&lt;body&gt;](../body/), [&lt;context&gt;](../context/) o [&lt;switch&gt;](../switch/) |
