...
El elemento [&lt;causalConnector&gt;](../causalconnector/) representa una relación causal que puede ser
Se utiliza para crear relaciones (elementos [&lt;link&gt;](../link/)) en documentos NCL.  en
En una relación causal, se debe cumplir una condición para desencadenar una
acción.

Un [&lt;causalConnector&gt;](../causalconnector/) especifica una relación independientemente de
relaciones, es decir, no especifica qué nodos (representados por
[&lt;media&gt;](../media/), [&lt;context&gt;](../context/), [&lt;body&gt;](../body/) y [&lt;switch&gt;](../switch/) elementos)
interactúan a través de la relación.  Un elemento [&lt;link&gt;](../link/), a su vez,
...
Un [&lt;causalConnector&gt;](../causalconnector/) define, a través de sus elementos secundarios, un conjunto de
puntos de interfaz, llamados roles.  Un elemento [&lt;link&gt;](../link/) hace referencia a un
[&lt;causalConnector&gt;](../causalconnector/) y define un conjunto de enlaces ([&lt;bind&gt;](../bind/) hijo
elementos del elemento [&lt;link&gt;](../link/)), que asocian cada punto final del enlace
...
- evento de presentación: definido por la presentación de un subconjunto de
    ...
    especificado en NCL en [&lt;area&gt;](../area/) elementos, o en los propios nodos de medios
    (en todos sus anclajes de contenido).  Los eventos de presentación también pueden ser
    definido en nodos compuestos (representados por [&lt;body&gt;](../body/), [&lt;context&gt;](../context/),
    o [&lt;switch&gt;](../switch/) elementos), que representan la presentación de información
...
- evento de atribución: definido por la atribución de un valor a una propiedad
    de un nodo (representado por [&lt;media&gt;](../media/), [&lt;body&gt;](../body/) o [&lt;context&gt;](../context/)
    elemento), que debe declararse en un elemento secundario [&lt;property&gt;](../property/) de
    el nodo; y

  - evento de composición: definido por la presentación de la estructura de un
    nodo compuesto (representado por [&lt;body&gt;](../body/), [&lt;context&gt;](../context/) o
    [&lt;switch&gt;](../switch/) elemento).  Los eventos de composición se utilizan para presentar la
...
| --- | --- | --- | --- | --- | --- |
| [&lt;causalConnector&gt;](../causalconnector/) | <u>*id*</u> | ([&lt;connectorParam&gt;](../connectorparam/)*, ([&lt;simpleCondition&gt;](../simplecondition/) | [&lt;compoundCondition&gt;](../compoundcondition/)), ([&lt;simpleAction&gt;](../simpleaction/) | [&lt;compoundAction&gt;](../compoundaction/))) | [&lt;connectorBase&gt;](../connectorbase/) |
