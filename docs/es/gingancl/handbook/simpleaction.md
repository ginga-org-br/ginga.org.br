...
El elemento [&lt;simpleAction&gt;](../simpleaction/) define una acción simple desencadenada por el
Evaluación de una condición de relación causal.

El elemento [&lt;simpleAction&gt;](../simpleaction/) tiene un atributo *role*, cuyo valor
...
Un [&lt;simpleAction&gt;](../simpleaction/) también define un tipo de evento (*eventType*
...
Si un valor *eventType* es "atribución", el [&lt;simpleAction&gt;](../simpleaction/)debe
...
*rol* "anyName" y definido por un elemento secundario [&lt;bind&gt;](../bind/) del
[&lt;link&gt;](../link/) elemento que hace referencia al conector.  Si este valor no puede ser
recuperado, no se hace ninguna atribución.  Éste es el único caso posible de
[&lt;bind&gt;](../bind/) elemento que hace referencia a un rol que no está declarado explícitamente en un
conector.
...
rol (es decir, el número de enlaces) cuando se utiliza [&lt;causalConnector&gt;](../causalconnector/)
para crear un [&lt;link&gt;](../link/). Si el valor máximo es mayor que uno, el
...
También se puede definir un atributo *retraso* para un [&lt;simpleAction&gt;](../simpleaction/),
especificando que la acción debe ser ejecutada sólo después de esperar la
tiempo especificado.

El [&lt;simpleAction&gt;](../simpleaction/) también puede definir un atributo *repetido* para ser
asignado al atributo *repeticiones* del evento, y un
*repeatDelay* se esperará antes de repetir la acción.

El elemento [&lt;simpleAction&gt;](../simpleaction/) también puede definir la duración y por
...
| --- | --- | --- | --- |
| [&lt;simpleAction&gt;](../simpleaction/) | <u>*role*</u>, *delay*, *eventType*, *actionType*, *value*, *min*, *max*, *qualifier*, *repeat*, *repeatDelay*, *duration*, *by* | -- | [&lt;causalConnector&gt;](../causalconnector/) o [&lt;compoundAction&gt;](../compoundaction/) |
...
| *repetir* | Entero positivo.  El valor predeterminado es 0 | El atributo *repeat* define un valor que se asignará al atributo de repeticiones del evento definido en el elemento [&lt;simpleAction&gt;](../simpleaction/). |
