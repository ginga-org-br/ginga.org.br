...
El elemento [&lt;attributeAssessment&gt;](../attributeassessment/) se utiliza para definir una variable que se
evaluado, en [&lt;assessmentStatement&gt;](../assessmentstatement/) elementos, frente a otra variable
valores o un valor absoluto.

La variable puede ser una propiedad especificada en un elemento [&lt;property&gt;](../property/), o
...
El elemento [&lt;attributeAssessment&gt;](../attributeassessment/) tiene un atributo *rol*, que
tiene que ser único en el conjunto de roles del conector.  Este atributo es el conector.
punto de interfaz, que está asociado a las interfaces de nodo ([&lt;port&gt;](../port/),
[&lt;area&gt;](../area/), [&lt;property&gt;](../property/) o [&lt;switchPort&gt;](../switchport/) elementos) por un [&lt;link&gt;](../link/)
...
atributo y su atributo *attributeType*:
  ...
  * Si el valor de eventType es "selección", el [&lt;attributeAssessment&gt;](../attributeassessment/)puede
...
Se puede agregar un valor de compensación a un [&lt;attributeAssessment&gt;](../attributeassessment/) antes de su
comparación en un elemento [&lt;assessmentStatement&gt;](../assessmentstatement/).  Por ejemplo, una compensación
...
| --- | --- | --- | --- |
| [&lt;attributeAssessment&gt;](../attributeassessment/) | <u>*rol*</u>, <u>*eventType*</u>, *clave*, *attributeType*, *offset* | -- | [&lt;assessmentStatement&gt;](../assessmentstatement/) |
