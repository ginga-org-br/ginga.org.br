...
El elemento [&lt;link&gt;](../link/) define una relación entre medios y compuestos.
objetos.

Un elemento [&lt;link&gt;](../link/) puede tener un atributo *id*, que de forma única
...
El elemento [&lt;causalConnector&gt;](../causalconnector/) referido define la relación sin
especificando quién desempeña los roles de relación.  Quién juega se define usando
[&lt;bind&gt;](../bind/) elementos, hijos del elemento [&lt;link&gt;](../link/).

### Sintaxis { data-search-exclude }

| Elemento | Atributos | Contenido | Padre |
| --- | --- | --- | --- |
| [&lt;link&gt;](../link/) | *id*, <u>*xconector*</u> | ([&lt;linkParam&gt;](../linkparam/)*, [&lt;bind&gt;](../bind/)+) | [&lt;body&gt;](../body/) o [&lt;context&gt;](../context/) o [&lt;switch&gt;](../switch/) |
