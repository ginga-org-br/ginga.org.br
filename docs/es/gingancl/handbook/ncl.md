...
El elemento [&lt;ncl&gt;](../ncl/) representa la raíz de un documento NCL.

El elemento [&lt;ncl&gt;](../ncl/) es el contenedor de todos los demás elementos NCL (excepto
la declaración <?xml>).
...
| --- | --- | --- | --- |
| [&lt;ncl&gt;](../ncl/) | <u>*id*</u>, *título*, *xmlns* | ([&lt;head&gt;](../head/)?, [&lt;body&gt;](../body/)?) | -- |
