...
El elemento [&lt;region&gt;](../region/) define los valores iniciales para los lados izquierdo, derecho,
Propiedades superior, inferior, altura, ancho y zIndex de un elemento [&lt;media&gt;](../media/)
que indirectamente se refiere a él mediante el uso de un elemento [&lt;descriptor&gt;](../descriptor/).
...
geometría, que está definida por el elemento principal [&lt;region&gt;](../region/), o el total
...
| --- | --- | --- | --- |
| [&lt;region&gt;](../region/) | <u>*id*</u>, *título*, *izquierda*, *derecha*, *arriba*, *abajo*, *alto*, *ancho*, *zIndex* | ([&lt;region&gt;](../region/))* | [&lt;regionBase&gt;](../regionbase/) o [&lt;region&gt;](../region/) |
