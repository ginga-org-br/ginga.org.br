...
El elemento [&lt;switch&gt;](../switch/) permite definir objetos alternativos
(representado por [&lt;media&gt;](../media/), [&lt;context&gt;](../context/) u otro [&lt;switch&gt;](../switch/)
...
definido por elementos [&lt;rule&gt;](../rule/) y [&lt;compositeRule&gt;](../compositerule/); [&lt;bindRule&gt;](../bindrule/)
Los elementos secundarios asocian estas reglas a los objetos del componente secundario del
[&lt;switch&gt;](../switch/) elemento.

Un elemento secundario [&lt;switchPort&gt;](../switchport/) puede definir una asignación a un subconjunto del
componentes secundarios del conmutador.  Cuando un enlace está vinculado a un [&lt;switchPort&gt;](../switchport/)
...
se elige el componente, definido por el elemento secundario [&lt;defaultComponent&gt;](../defaultcomponent/); si
el elemento [&lt;defaultComponent&gt;](../defaultcomponent/) no está definido, no hay ningún componente seleccionado
...
[&lt;switchPort&gt;](../switchport/) elementos o, de forma predeterminada, al elemento [&lt;switch&gt;](../switch/)
sin especificar ningún [&lt;switchPort&gt;](../switchport/).  En este caso se considera como
si la referencia se hace a un [&lt;switchPort&gt;](../switchport/) predeterminado que contiene
mapear elementos a cada objeto hijo del interruptor y hacer referencia a su
ancla de contenido completo.

Desde el momento en que se evalúa un [&lt;switch&gt;](../switch/) se considera resuelto
hasta el final de la presentación del interruptor actual.

El elemento [&lt;switch&gt;](../switch/) puede hacer referencia a otro elemento [&lt;switch&gt;](../switch/).  en
...
| --- | --- | --- | --- |
| [&lt;switch&gt;](../switch/) | <u>*id*</u>, *referir* | ([&lt;defaultComponent&gt;](../defaultcomponent/)?, ([&lt;switchPort&gt;](../switchport/) &#124; [&lt;bindRule&gt;](../bindrule/) &#124; [&lt;media&gt;](../media/) &#124; [&lt;context&gt;](../context/) &#124; [&lt;switch&gt;](../switch/))*) | [&lt;body&gt;](../body/), [&lt;context&gt;](../context/) o [&lt;switch&gt;](../switch/) |
