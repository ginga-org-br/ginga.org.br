...
O elemento [&lt;simpleCondition&gt;](../simplecondition/) define uma condição simples para acionar
ações em uma relação causal.

O elemento [&lt;simpleCondition&gt;](../simplecondition/) possui um role *attribute*, cujo valor
...
Um [&lt;simpleCondition&gt;](../simplecondition/) também define um tipo de evento (*eventType*
...
número de ligações) quando o [&lt;causalConnector&gt;](../causalconnector/) é usado para criar um
[&lt;link&gt;](../link/).  Se o valor máximo for maior que um, um qualificador
...
Um atributo de atraso também pode ser definido para um [&lt;simpleCondition&gt;](../simplecondition/),
...
| --- | --- | --- | --- |
| [&lt;simpleCondition&gt;](../simplecondition/) | <u>*papel*</u>, *atraso*, *eventType*, *chave*, *transição*, *min*, *máx*, *qualificador* | -- | [&lt;causalConnector&gt;](../causalconnector/) ou [&lt;compoundCondition&gt;](../compoundcondition/) |
