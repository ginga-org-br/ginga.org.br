...
O elemento [&lt;area&gt;](../area/) permite definir uma âncora de conteúdo (um subconjunto de
unidades de informação do conteúdo de um elemento [&lt;media&gt;](../media/)) que podem ser usadas em
...
Cada elemento [&lt;media&gt;](../media/), [&lt;context&gt;](../context/), [&lt;body&gt;](../body/) e [&lt;switch&gt;](../switch/)
...
| --- | --- | --- | --- |
| [&lt;area&gt;](../area/) | <u>*id*</u>, *coords*, *begin*, *end*, *beginText*, *endText*, *beginPosition*, *endPosition*, *first*, *last*, *label*, *clip* | -- | [&lt;media&gt;](../media/) |
