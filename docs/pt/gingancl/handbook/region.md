...
O elemento [&lt;region&gt;](../region/) define os valores iniciais para a esquerda, direita,
Propriedades superior, inferior, altura, largura e zIndex de um elemento [&lt;media&gt;](../media/)
que indiretamente se refere a ele usando um elemento [&lt;descriptor&gt;](../descriptor/).

A posição de uma região, conforme especificado por seu *top*, *bottom*,
Os atributos *left* e *right* são sempre relativos ao pai
geometria, que é definida pelo elemento pai [&lt;region&gt;](../region/) ou pelo total
...
| --- | --- | --- | --- |
| [&lt;region&gt;](../region/) | <u>*id*</u>, *título*, *esquerda*, *direita*, *superior*, *inferior*, *altura*, *largura*, *zIndex* | ([&lt;region&gt;](../region/))* | [&lt;regionBase&gt;](../regionbase/) ou [&lt;region&gt;](../region/) |
