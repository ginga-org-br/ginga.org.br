...
O elemento [&lt;transition&gt;](../transition/) permite definir um modelo de transição.

### Sintaxe { data-search-exclude }

| Elemento | Atributos | Conteúdo | Pai |
| --- | --- | --- | --- |
| [&lt;transition&gt;](../transition/) | <u>*id*</u>, <u>*tipo*</u>, *subtipo*, *dur*, *startProgress*, *endProgress*, *direção*, *fadeColor*, *horzRepeat*, *vertRepeat*, *borderWidth*, *borderColor* | -- | [&lt;transitionBase&gt;](../transitionbase/) |
