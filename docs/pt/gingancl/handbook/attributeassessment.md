...
O elemento [&lt;attributeAssessment&gt;](../attributeassessment/) é usado para definir uma variável a ser
avaliado, em elementos [&lt;assessmentStatement&gt;](../assessmentstatement/), em relação a outra variável
valores ou um valor absoluto.

A variável pode ser uma propriedade especificada em um elemento [&lt;property&gt;](../property/) ou
...
O elemento [&lt;attributeAssessment&gt;](../attributeassessment/) possui um atributo *role*, que
deve ser exclusivo no conjunto de funções do conector.  Este atributo é o conector
ponto de interface, que está associado às interfaces do nó ([&lt;port&gt;](../port/),
[&lt;area&gt;](../area/), [&lt;property&gt;](../property/) ou [&lt;switchPort&gt;](../switchport/) elementos) por [&lt;link&gt;](../link/)
...
atributo e seu atributo *attributeType*:
  ...
  * Se o valor eventType for "selection", o [&lt;attributeAssessment&gt;](../attributeassessment/)pode
...
Um valor de deslocamento pode ser adicionado a um [&lt;attributeAssessment&gt;](../attributeassessment/) antes de seu
comparação em um elemento [&lt;assessmentStatement&gt;](../assessmentstatement/).  Por exemplo, um deslocamento
...
| *atributoType* | <p>"nodeProperty" (somente no caso de *eventType*="atribuição"), "ocorrências", "repetição" ou "estado".</p><p>Os valores padrão são: "nodeProperty" se *eventType*="atribuição" ou "ocorrências" se *eventType*="seleção".</p> | O atributo *attributeType* identifica a variável a ser avaliada em um elemento [&lt;assessmentStatement&gt;](../assessmentstatement/). |
| *deslocamento* | Corda. | O atributo *offset* especifica um valor a ser adicionado à variável selecionada antes de sua avaliação em um elemento [&lt;assessmentStatement&gt;](../assessmentstatement/). |