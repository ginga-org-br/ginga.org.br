...
O elemento [&lt;simpleAction&gt;](../simpleaction/) define uma ação simples acionada pelo
avaliação de uma condição de relacionamento causal.

O elemento [&lt;simpleAction&gt;](../simpleaction/) possui um atributo *role*, cujo valor
...
Um [&lt;simpleAction&gt;](../simpleaction/) também define um tipo de evento (*eventType*
...
Se um valor *eventType* for "atribuição", o [&lt;simpleAction&gt;](../simpleaction/)deve
...
*role* "anyName" e definido por um elemento filho [&lt;bind&gt;](../bind/) do
[&lt;link&gt;](../link/) elemento que faz referência ao conector.  Se este valor não puder ser
recuperado, nenhuma atribuição é feita.  Este é o único caso possível de
[&lt;bind&gt;](../bind/) elemento referente a uma função que não está explicitamente declarada em um
conector.
...
função (ou seja, o número de ligações) quando o [&lt;causalConnector&gt;](../causalconnector/) é usado
para criar um [&lt;link&gt;](../link/). Se o valor máximo for maior que um, o
...
Um atributo *delay* também pode ser definido para um [&lt;simpleAction&gt;](../simpleaction/),
especificando que a ação deve ser disparada somente após esperar pelo
tempo especificado.

O [&lt;simpleAction&gt;](../simpleaction/) também pode definir um atributo *repeat* para ser
atribuído ao atributo *repetições* do evento, e um
*repeatDelay* a ser esperado antes de repetir a ação.

O elemento [&lt;simpleAction&gt;](../simpleaction/) também pode definir a duração e por
...
| --- | --- | --- | --- |
| [&lt;simpleAction&gt;](../simpleaction/) | <u>*role*</u>, *atraso*, *eventType*, *actionType*, *valor*, *min*, *max*, *qualificador*, *repeat*, *repeatDelay*, *duração*, *por* | -- | [&lt;causalConnector&gt;](../causalconnector/) ou [&lt;compoundAction&gt;](../compoundaction/) |
...
| *repetir* | Inteiro positivo.  O valor padrão é 0 | O atributo *repeat* define um valor a ser atribuído ao atributo de repetições do evento definido no elemento [&lt;simpleAction&gt;](../simpleaction/). |
