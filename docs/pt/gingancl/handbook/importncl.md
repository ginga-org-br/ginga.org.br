...
O elemento [&lt;importNCL&gt;](../importncl/) permite incorporar outro documento NCL
especificação.  Como consequência, todas as bases definidas dentro do NCL importado
documento, bem como o elemento [&lt;body&gt;](../body/) do documento, são importados, todos em
uma vez.  As bases serão tratadas como se cada uma fosse importada por [&lt;importBase&gt;](../importbase/)
elementos.  O elemento [&lt;body&gt;](../body/) importado será tratado como um [&lt;context&gt;](../context/)
elemento.  Deve-se ressaltar que o elemento [&lt;importNCL&gt;](../importncl/) não
...
[&lt;importNCL&gt;](../importncl/) elemento.  Assim, o [&lt;body&gt;](../body/) importado, bem como qualquer um de seus
nós contidos, podem ser reutilizados dentro do elemento [&lt;body&gt;](../body/) da importação
Documento NCL.

O atributo *documentURI* do elemento [&lt;importNCL&gt;](../importncl/) refere-se a um URI
...
elementos definidos nas bases de documentos importados indiretamente ([&lt;regionBase&gt;](../regionbase/),
