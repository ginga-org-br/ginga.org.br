...
O elemento [&lt;linkParam&gt;](../linkparam/) é usado para atribuir um valor a um parâmetro
...
o valor atribuído é todo o elemento pai [&lt;link&gt;](../link/).

Em um elemento [&lt;linkParam&gt;](../linkparam/), o atributo *name* refere-se ao nome
...
| --- | --- | --- | --- |
| [&lt;linkParam&gt;](../linkparam/) | <u>*nome*</u>, <u>*valor*</u> | -- | [&lt;link&gt;](../link/) |
...
| *valor* | Depende do parâmetro definido pelo elemento [&lt;connectorParam&gt;](../connectorparam/). | O atributo *value* define um valor para o parâmetro.  O valor é, portanto, válido para toda a definição de [&lt;link&gt;](../link/). |