...
O elemento [&lt;rule&gt;](../rule/) define regras simples para definir qualquer alternativa
...
nó de configurações (elemento [&lt;media&gt;](../media/) do tipo application/x-ncl-settings),
isto é, o atributo *var* deve ter como valor um nome de propriedade de
o elemento [&lt;media&gt;](../media/) do tipo "application/x-ncl-settings".

### Sintaxe { data-search-exclude }

| Elemento | Atributos | Conteúdo | Pai |
| --- | --- | --- | --- |
| [&lt;rule&gt;](../rule/) | *id*, <u>*var*</u>, <u>*comparador*</u>, <u>*valor*</u> | -- | [&lt;ruleBase&gt;](../rulebase/) ou [&lt;compositeRule&gt;](../compositerule/) |
...
| *var* | Pode receber qualquer valor de string que comece com uma letra ou sublinhado e que contenha apenas letras, dígitos, <"."> e <"_">. | O atributo *var* identifica exclusivamente um nome de propriedade do nó de configurações (elemento [&lt;media&gt;](../media/) do tipo "application/x-ncl-settings"). |
