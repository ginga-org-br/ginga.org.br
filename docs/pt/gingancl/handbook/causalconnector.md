...
O elemento [&lt;causalConnector&gt;](../causalconnector/) representa uma relação causal que pode ser
usado para criar relacionamentos (elementos [&lt;link&gt;](../link/)) em documentos NCL.  Em
uma relação causal, uma condição deve ser satisfeita para desencadear uma
ação.

Um [&lt;causalConnector&gt;](../causalconnector/) especifica uma relação independentemente de
relacionamentos, ou seja, não especifica quais nós (representados por
[&lt;media&gt;](../media/), [&lt;context&gt;](../context/), [&lt;body&gt;](../body/) e [&lt;switch&gt;](../switch/) elementos) irão
interagir através da relação.  Um elemento [&lt;link&gt;](../link/), por sua vez,
...
Um [&lt;causalConnector&gt;](../causalconnector/) define, através de seus elementos filhos, um conjunto de
pontos de interface, chamados de funções.  Um elemento [&lt;link&gt;](../link/) refere-se a um
[&lt;causalConnector&gt;](../causalconnector/) e define um conjunto de vínculos ([&lt;bind&gt;](../bind/) filho
elementos do elemento [&lt;link&gt;](../link/)), que associam cada ponto final do link
...
- evento de apresentação: definido pela apresentação de um subconjunto de
    ...
    especificado em NCL em elementos [&lt;area&gt;](../area/) ou nos próprios nós de mídia
    (em todas as âncoras de conteúdo).  Eventos de apresentação também podem ser
    definido em nós compostos (representados por [&lt;body&gt;](../body/), [&lt;context&gt;](../context/),
    ou [&lt;switch&gt;](../switch/) elementos), representando a apresentação de informações
...
- evento de atribuição: definido pela atribuição de um valor a um imóvel
    de um nó (representado por [&lt;media&gt;](../media/), [&lt;body&gt;](../body/) ou [&lt;context&gt;](../context/)
    elemento), que deve ser declarado em um elemento filho [&lt;property&gt;](../property/) de
    o nó; e

  - evento de composição: definido pela apresentação da estrutura de um
    nó composto (representado por um [&lt;body&gt;](../body/), [&lt;context&gt;](../context/) ou
    [&lt;switch&gt;](../switch/) element).  Composition events are used to present the
